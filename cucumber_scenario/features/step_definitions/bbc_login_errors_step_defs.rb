...
# end
#
# And(/^I input the necessary details with the email details (.*)$/) do |email|
#   bbc_register_page.fill_in_email(email)
#   sleep 2
#   bbc_register_page.fill_in_password('12345')
#   sleep 1
#   bbc_register_page.password_field.send_keys :tab
# end
#
# Then(/^I receive the corresponding error from incorrect email (.*)$/) do |error_message_email|
#   expect(bbc_register_page.check_error_message).to eq error_message_email
# end
